...
export const About = () => {
    ...
    return (
        <Dialog width={400} className="about" open={show}>
            {() => (
                <>
                    ...
                    <Content>
                        <p className="about__paragraph">
                            Welcome to this Solo Apps experiment. This is very much a work in progress. Things{" "}
                            <b>will</b> break, not exist, make no sense and crash! This project is inspired by the
                            amazing work the people at Steinberg are doing on Dorico. If you haven't checked it out, I
                            recommend you do!
                        </p>
                    ...
                    <div className="about__buttons">
                        ...
                        <Button color={THEME.primary[400]} onClick={actions.ui.about.close}>
                            Close
                        </Button>
                    </div>
                </>
