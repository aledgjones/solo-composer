...
import { Select, Option, Input, Button, Subheader, Dialog } from 'solo-ui';
...
export const EngravingSettings: FC<Props> = ({ open, config, onUpdate, onClose }) => {
        ...
        {() => {
            return <>
                ...
                <div className="generic-settings__buttons">
                    <Select style={{ width: 300, marginRight: 8 }} label="" value={key} color={bg} onChange={setKey}>
