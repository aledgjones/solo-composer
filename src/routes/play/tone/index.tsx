...
interface Props {
    ...
    onEdit: (e: PointerEvent<HTMLElement>, tone: Entry<Tone>, fixedStart: boolean, fixedDuration: boolean, fixedPitch: boolean) => void;
...
export const ToneElement: FC<Props> = ({ flowKey, trackKey, tone, selected, color, top, left, width, tool, onEdit, onPlay }) => {
    ...
    const actionWest = useCallback((e: PointerEvent<HTMLElement>) => onEdit(e, tone, false, false, true), [tone, onEdit]);
    const action = useCallback((e: PointerEvent<HTMLElement>) => onEdit(e, tone, false, true, false), [tone, onEdit]);
    const actionEast = useCallback((e: PointerEvent<HTMLElement>) => onEdit(e, tone, true, false, true), [tone, onEdit]);
