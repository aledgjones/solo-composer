...
it('splits notes at barlines only', () => {
    ...
    const output = splitAsPerMeter(12, flow, track);
...
it('renders a full bar rest as such - 3/4', () => {
    ...
    const flow: EntriesByTick = {
        [0]: [createTimeSignature({ beats: 3, beatType: 4, groupings: getDefaultGroupings(4) }, 0)]
    }
...
it('renders a full bar rest as such - 6/8', () => {
    ...
    const flow: EntriesByTick = {
        [0]: [createTimeSignature({ beats: 6, beatType: 8, groupings: getDefaultGroupings(6) }, 0)]
    }
...
it('renders correctly - 12/8 [q-----------]', () => {
    ...
    const flow: EntriesByTick = {
        [0]: [createTimeSignature({ beats: 12, beatType: 8, groupings: getDefaultGroupings(12) }, 0)]
    }
...
it('renders correctly - 9/8 [c.------]', () => {
    ...
    const flow: EntriesByTick = {
        [0]: [createTimeSignature({ beats: 9, beatType: 8, groupings: getDefaultGroupings(9) }, 0)]
    }
